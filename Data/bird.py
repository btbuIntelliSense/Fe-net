...
# DATAPATH = '/media/btbu/gt/WHX/whx/CUB_200_2011/CUB_200_2011'
DATAPATH = r'F:\Data\CUB_200_2011\CUB_200_2011'
image_path = {}
image_label = {}
...
class BirdDataset(Dataset):
    ...
    def __init__(self, phase='train', resize=500, cropsize=448):
        ...
        # transform
        self.transform = get_transform(self.resize, self.cropsize, self.phase)
